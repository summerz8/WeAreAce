...
public class dataSetUp {
    ...
    @EJB
    private IntegratedPlannedOrderManagementLocal ipom;
    @EJB
    ...
    public void createDatabase() {
        ...
        //Raw material In-Factory Use Movement
            ...
            em.flush();
            StoragePlaceEntity stp1_6 = new StoragePlaceEntity(k1, "Temporary Refrigerator 1");
            em.persist(stp1_6);
            em.flush();
            k1.getStoragePlaces().add(stp1_6);
            em.flush();
            StoragePlaceEntity stp1_7 = new StoragePlaceEntity(k1, "Temporary Shelf 1");
            em.persist(stp1_7);
            em.flush();
            k1.getStoragePlaces().add(stp1_7);
            em.flush();
            StoragePlaceEntity stp1_8 = new StoragePlaceEntity(k1, "Temporary Shelf 2");
            em.persist(stp1_8);
            em.flush();
            k1.getStoragePlaces().add(stp1_8);
            em.flush();
            ...
            IngredientEntity i1_4 = new IngredientEntity("Crab", 250.0, "KG", "Free local delivery", 10.0, k1, ks1_1);
            em.persist(i1_4);
            em.flush();
            ArrayList<StoragePlaceEntity> stps1_4 = new ArrayList<>();
            stps1_4.add(stp1_1);
            stps1_4.add(stp1_6);
            for (StoragePlaceEntity storagePlace : stps1_4) {
                i1_4.getStoragePlaces().add(storagePlace);
                storagePlace.getIngredients().add(i1_4);
            }
            i1_4.getKitchen().getIngredients().add(i1_4);
            i1_4.getSupplier().getIngredients().add(i1_4);
            em.flush();
            ...
            em.flush();
            IngredientItemEntity ii1_1_3 = new IngredientItemEntity(i1_1, 1.0);
            em.persist(ii1_1_3);
            em.flush();
            ii1_1_3.getIngredient().getDishes().add(d1_1);
            d1_1.getRecipe().add(ii1_1_3);
            ...
            em.flush();
            IngredientItemEntity ii1_2_3 = new IngredientItemEntity(i1_4, 0.5);
            em.persist(ii1_2_3);
            em.flush();
...
//            ProductionPlanEntity pp = (ProductionPlanEntity) q.getResultList().get(0);
            
//            List<WeeklyProductionPlanEntity> wps = wpp.generateWeeklyProductionPlan(33L);
//            wps.get(0).setId(33L);
//            wps.get(1).setId(34L);
//            wps.get(2).setId(35L);
