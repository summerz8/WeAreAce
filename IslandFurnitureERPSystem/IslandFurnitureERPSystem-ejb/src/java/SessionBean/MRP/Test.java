...
public class Test {
    ...
    public void createDatabase() {
        ...
        UserEntity u = new HQUserEntity("H", "1000001", 0,                            "Zheng", null, "Yuan", "Global Manager", birthday, "Female", null, null, null, null, 1L, cryptographicHelper.doMD5Hashing("123"), false);
...
//        f2.setCountry("China"); f3.setCountry("United States");
        f1.setAddress("Sky");
//        f2.setAddress("hell");f3.setAddress("heaven");
        f1.setContact("1234567");
//        f2.setContact("7654321");f3.setContact("9876543");
        f1.setManager("Meng Dan");
//        f2.setManager("MD");f3.setManager("ZMD");
        f1.setDeleteFlag(Boolean.FALSE);
//        f2.setDeleteFlag(Boolean.FALSE);f3.setDeleteFlag(Boolean.FALSE);
//        
        em.persist(f1);em.flush();
//        em.persist(f2);em.flush();em.persist(f3);em.flush();
//        
...
//        
        em.persist(rm1);em.flush();
//        em.persist(rm2);em.flush();em.persist(rm3);em.flush();em.persist(rm4);em.flush();em.persist(rm5);em.flush();
//        
...
//        
        frm1.setFactory(f1);
//        frm2.setFactory(f1);frm3.setFactory(f1);frm4.setFactory(f1);frm5.setFactory(f1);
...
//        
        frm1.setRawMaterial(rm1);
//        frm2.setRawMaterial(rm2);frm3.setRawMaterial(rm3);frm4.setRawMaterial(rm4);frm5.setRawMaterial(rm5);
...
//        
        em.persist(frm1);em.flush();
//        em.persist(frm2);em.flush();em.persist(frm3);em.flush();em.persist(frm4);em.flush();em.persist(frm5);em.flush();
...
//        em.persist(s2);em.persist(s3);em.persist(s4);em.persist(s5);
